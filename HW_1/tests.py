...
def test_create_task():
    ...
    response = requests.post(task_url, json={"code": "print('Hello, world!')", "compiler": "python"})
...
def test_task_status_and_result():
    ...
    result_url = f"{BASE_URL}/result?task_id={task_id}"
...
def test_task_not_found():
    ...
    status_url = f"{BASE_URL}/status?task_id={invalid_task_id}"
    result_url = f"{BASE_URL}/result?task_id={invalid_task_id}"
